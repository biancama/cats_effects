...
```scala
libraryDependencies += "org.typelevel" %% "cats-effect-testkit" % "3.4.8" % Test
```
...
![the cats effect hierarchy of typeclasses as of version 3.0 with Cats](images/cats_effects_and_cats.png)
